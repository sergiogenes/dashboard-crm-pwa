...
export async function sendPasswordResetEmail(to: string, resetLink: string): Promise<void> {
  ...
  const msg = {
    to,
    from: fromEmail,
    subject: 'Restablecer contraseña - Portal de Vendedores',
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #DFE7E4; border-radius: 8px;">
        ...
        <p>Hola,</p>
        <p>Has recibido este correo porque se solicitó un restablecimiento de contraseña para tu cuenta en el Portal de Vendedores.</p>
        ...
        <p style="font-size: 12px; color: #526C71; text-align: center;">Portal de Vendedores - Seguridad y Sincronización</p>
      </div>
    `,
  }
